...
class BGS:
    def __init__(self, root_path, periodrange, thresh=3, kernel=(4, 4)):
        ...
        self.length = int()
        self.shape = ()
        self.path = os.path.join(root_path, 'cache')
    ...
    def post_process(self, framecount):
        ...
        # model = joblib.load(r'D:\workspace\python\objectTracking\online_tracking\config.pkl')
