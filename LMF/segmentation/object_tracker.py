...
# Paths
root_path = PATH.imgpath
out_path = PATH.filepath
video_path = os.path.join(root_path, args["video"])
...
dish_map = mt.dishmap
joblib.dump(OBJ, os.path.join(out_path, 'objects.pkl'))
joblib.dump(dish_map, os.path.join(out_path, 'map.pkl'))
print('data saved')

shutil.rmtree(os.path.join(root_path, 'cache'))
